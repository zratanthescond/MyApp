...
const ListBordereau = () => {
  ...
  const { data, isError, isLoading } = useQuery({
    queryKey: ["bordereau", contractId, refresh],
  ...
  return (
    <ScrollView
      contentContainerStyle={[layout.justifyCenter, gutters.paddingBottom_80]}
    >
        ...
        {data && data.$values.length > 0 ? (
          data.$values.map((bordereau: any) => (
            <TouchableWithoutFeedback
              ...
              onPress={() =>
                navigation.navigate("ListFacture", {
              ...
              <View key={bordereau.bordereauId} style={styles.ticketContainer}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.value}>
                    {formatDate(bordereau.dateBordereau)}
                  </Text>
                </View>
                <View style={styles.infoRow}>
